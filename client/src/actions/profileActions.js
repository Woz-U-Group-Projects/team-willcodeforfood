...
export const createTruck = (profileData, history) => dispatch => {
  axios
    .post("/api/profile", profileData)
    .then(res => history.push("/dashboard"))
    .catch(err =>
...
// Add Truck
export const addTruck = (truData, history) => dispatch => {
  axios
    .post("/api/profile/Truck", truData)
    .then(res => history.push("/dashboard"))
    .catch(err =>
      dispatch({
        type: GET_ERRORS,
